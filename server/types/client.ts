...
export interface ClientApiCredential {
  id: string;
  clientId: string; // e.g. key_live_7a8b9c...
  clientSecret: string; // e.g. sec_live_••••••••3a4f (masked in listings)
  plainSecret?: string; // Returned ONLY on creation/rotation
  name: string;
...
export interface ClientListItem {
  id: string; // Client profile ID (e.g. cli-prof-001)
  userId: string;
  username: string;
  firstName: string;
  lastName: string;
